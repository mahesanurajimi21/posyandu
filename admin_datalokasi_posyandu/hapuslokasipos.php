  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Hapus Data Posyandu</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $hapusposynd =trim(mysqli_real_escape_string($con, $_POST['hps_posyandu1']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_lokasi_posyandu") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_lokasi_posyandu WHERE id = '$hapusposynd'") or die(mysqli_error($con));
                ?>
