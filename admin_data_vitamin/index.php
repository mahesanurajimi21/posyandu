        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header" style="background-color:#4682B4">
                <h3 class="card-title"><font color ="#fffff"><i class="nav-icon fas fa-users">&nbsp</i> Data Vitamin</font></h3>
              </div>
              ...
              <!-- <a href="tambahpengguna.php" class="btn btn-default btn-md" style="background-color:#001f3f;"
               ...
               <font color ="#fffff"> <i class="nav-icon fas fa-plus">&nbsp</i>Tambah Data</font></button>
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <?php
                    $no=1;
                    $sql_pengguna = mysqli_query($con, " SELECT * FROM tbl_vitamin") or die (mysqli_error($con));
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form role="form" class="form-layout" action="hapusvitamin.php" method="post">
            <div class="alert alert-warning alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert" aria-hidden="true"></button>
                  <h5><i class="icon fas fa-exclamation-triangle"></i> Perhatian!</h5>
                  Anda Yakin Ingin Menghapus Data Ini?
                </div>
                <label for="exampleInputEmail1">Nama Vitamin</label>
              <input type="text" name="dt_vitamin" id="dt_vitamin" hidden >
            <br> <input type="text" name="vitamin" id="vitamin" disabled ></br>
            </div>
      ...
      <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
          ...
          <div class="modal-header" style="background-color:#4682B4;">
              <h5 class="modal-title"><font color="#ffffff">Tambah Data Vitamin</font></h5>
            </div>
            <div class="modal-body">
            <form role="form" class="form-layout" action="tambahvitamin.php" method="post">

            <div class="form-group">           
                <label for="exampleInputEmail1">Nama Vitamin</label>
                <input type="text" class="form-control" name="tbhvitamin" placeholder="nama vitamin.." required autofocus>
            </div>
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
          <div class="modal-header" style="background-color:#4682B4;">
              <h5 class="modal-title"><font color="#ffffff">Edit Data Vitamin</font></h5>
            </div>
            <div class="modal-body">
            <form role="form" class="form-layout" action="editvitamin.php" method="post">
            <div class="form-group">           
                <label for="exampleInputEmail1">ID</label>
                <input type="text" class="form-control" name="idvit"  disabled>
                <input type="text" class="form-control" name="idvit2" hidden>

            </div>
            <div class="form-group">           
                <label for="exampleInputEmail1">Nama Vitamin</label>
                <input type="text" class="form-control" name="edtvitamin" placeholder="vaksin...">
            </div>
      ...
      <script type="text/javascript">
        $('#modal-default').on('show.bs.modal', function(e){
          ...
          var vitamin = $(e.relatedTarget).data('id');
          var vit = $(e.relatedTarget).data('vitamin');

          $(e.currentTarget).find('input[name="dt_vitamin"]').val(vitamin);
          $(e.currentTarget).find('input[name="vitamin"]').val(vit);
         });
        </script> 
      ...
      <script type="text/javascript">
        $('#modal-edit').on('show.bs.modal', function(e){
          //get data id attribute of the clicked element
          var vitamin = $(e.relatedTarget).data('nama_vitamin');
          var id = $(e.relatedTarget).data('id');


          $(e.currentTarget).find('input[name="edtvitamin"]').val(vitamin);
          $(e.currentTarget).find('input[name="idvit"]').val(id);
          $(e.currentTarget).find('input[name="idvit2"]').val(id);
