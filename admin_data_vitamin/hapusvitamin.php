    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $hpsvitamin =trim(mysqli_real_escape_string($con, $_POST['dt_vitamin']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_vitamin") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_vitamin WHERE id = '$hpsvitamin'") or die(mysqli_error($con));
                ?>
