    ...
    <div class="content">
      <div class="container-fluid">
            ...
            if(isset($_POST['simpan']))
        {
            ...
            $cekdata = mysqli_query($con, "SELECT * FROM tbl_vitamin WHERE nama_vitamin='$smpnvitamin'")
            ...
            if (mysqli_num_rows($cekdata) > 0)
            {
              ...
              <script> 
              swal("Error", "Jenis Vitamin sudah ada, silahkan ganti yang lain", "error");
            ...
            {
                mysqli_query($con, "INSERT INTO tbl_vitamin VALUES ('','$smpnvitamin')")
            or die(mysqli_error($con));
            ?>
              <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
              <script> 
