      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <a class="btn btn-md bg-gradient-warning" href="../petugas_pengukuran_anak"><i class="nav-icon fas fa-chevron-left">&nbsp</i> Kembali</a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="form-group">           
                ...
                <input type="number" class="form-control" name="tbhtb"placeholder="Cm..."required>
            </div>
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          ...
          <div class="modal-header" style="background-color:#4682B4;">
            ...
            <div class="form-group">           
                <label for="exampleInputEmail1">TB(Cm)</label>
                <input type="number" class="form-control" name="edttb"placeholder="Tinggi Badan"required>
            </div>
        ...
        <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
          <script type="text/javascript">
            ...
            if (mysqli_num_rows($panggilberat6)>0)
            {
              ...
              $berat6 = $erre6['berat_badan'];          
              $tanggal6 = $erre6['tanggal'];
