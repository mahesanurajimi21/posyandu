  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        {
                    $pkrt        = trim(mysqli_real_escape_string($con, $_POST['nrt']));
                    $pkrw        = trim(mysqli_real_escape_string($con, $_POST['nrw']));
                    
            $cekdata = mysqli_query($con, "SELECT * FROM tbl_rt WHERE no_rt='$pkrt'OR no_rw='$pkrw'")
            ...
            if (mysqli_num_rows($cekdata) > 0)
            {
              ...
              <script> 
              swal("Error", "Nomer Rt dan Rw sudah ada, silahkan ganti Nomer yang lain", "error");
            ...
            {
                mysqli_query($con, "INSERT INTO tbl_rt VALUES ('','$pkrt','$pkrw')")
            or die(mysqli_error($con));
            ?>
              <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
              <script> 
