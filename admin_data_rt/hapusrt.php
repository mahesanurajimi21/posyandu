    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $rtn =trim(mysqli_real_escape_string($con, $_POST['pak_rt']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_rt") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_rt WHERE id = '$rtn'") or die(mysqli_error($con));
                ?>
