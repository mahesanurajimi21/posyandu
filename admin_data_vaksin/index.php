        ...
        <div class="row">
          ...
          <div class="card">
              <div class="card-header" style="background-color:#4682B4">
                <h3 class="card-title"><font color ="#fffff"><i class="nav-icon fas fa-users">&nbsp</i> Data Vaksin</font></h3>
              </div>
              ...
              <!-- <a href="tambahpengguna.php" class="btn btn-default btn-md" style="background-color:#001f3f;"
               ...
               <button type="button" class="btn btn-md bg-gradient"style="background-color:#4682B4"data-toggle="modal" data-target="#modal-tambah">
                ...
                <table id="example2" class="table table-bordered table-striped">
                  ...
                  <?php
                    $no=1;
                    $sql_pengguna = mysqli_query($con, " SELECT * FROM tbl_vaksin") or die (mysqli_error($con));
...
<div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="alert alert-warning alert-dismissible">
                ...
                <label for="exampleInputEmail1">Nama Vaksin</label>

              <input type="text" name="dt_vaksin" id="dt_vaksin" hidden >
              <br><input type="text" name="vaksin" id="vaksin" disabled ></br>
      ...
      <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
          ...
          <div class="modal-header" style="background-color:#4682B4;">
              <h5 class="modal-title"><font color="#ffffff">Tambah Vaksin</font></h5>
            </div>
            <div class="modal-body">
            <form role="form" class="form-layout" action="tambahvaksin.php" method="post">

            <div class="form-group">           
                <label for="exampleInputEmail1">Nama Vaksin</label>
                <input type="text" class="form-control" name="vaksin" placeholder="nama vaksin.." required autofocus>
            </div>
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
          <div class="modal-header" style="background-color:#4682B4;">
              <h5 class="modal-title"><font color="#ffffff">Edit Data Vaksin</font></h5>
            </div>
            <div class="modal-body">
            <form role="form" class="form-layout" action="editvaksin.php" method="post">
            <div class="form-group">           
                <label for="exampleInputEmail1">ID</label>
                <input type="text" class="form-control" name="idvks"  disabled>
                <input type="text" class="form-control" name="idvks2" hidden>

            </div>
            <div class="form-group">           
                <label for="exampleInputEmail1">Nama Vaksin</label>
                <input type="text" class="form-control" name="edtvaksin" placeholder="vaksin...">
            </div>
      ...
      <script type="text/javascript">
        $('#modal-default').on('show.bs.modal', function(e){
          ...
          var nama = $(e.relatedTarget).data('vaksin');

          $(e.currentTarget).find('input[name="dt_vaksin"]').val(vksin);
          $(e.currentTarget).find('input[name="vaksin"]').val(nama);
         });
        </script> 
      ...
      <script type="text/javascript">
        $('#modal-edit').on('show.bs.modal', function(e){
          //get data id attribute of the clicked element
          var vaksinn = $(e.relatedTarget).data('no_rt');
          var id = $(e.relatedTarget).data('id');


          $(e.currentTarget).find('input[name="edtvaksin"]').val(vaksinn);
          $(e.currentTarget).find('input[name="idvks"]').val(id);
          $(e.currentTarget).find('input[name="idvks2"]').val(id);
