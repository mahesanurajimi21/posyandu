  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0"> Tambah Data Dusun </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        {
                    // $idus         = trim(mysqli_real_escape_string($con, $_POST['ids']));
                    $namdusun         = trim(mysqli_real_escape_string($con, $_POST['nmadusun']));
                    $kaduse           = trim(mysqli_real_escape_string($con, $_POST['nmkadus']));
                    $kontakkaduse     = trim(mysqli_real_escape_string($con, $_POST['kntkadus']));

            $cekdata = mysqli_query($con, "SELECT * FROM tbl_dusun WHERE nama_dusun='$namdusun'")
            ...
            if (mysqli_num_rows($cekdata) > 0)
            {
              ...
              <script> 
              swal("Error", "Nama Dusun sudah digunakan, silahkan ganti yang lain", "error");
            ...
            {
                mysqli_query($con, "INSERT INTO tbl_dusun VALUES ('','$namdusun','$kaduse','$kontakkaduse')")
            or die(mysqli_error($con));
