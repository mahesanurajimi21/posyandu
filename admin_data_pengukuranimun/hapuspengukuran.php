  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Hapus Data Pengukuran</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $hpspengukuran =trim(mysqli_real_escape_string($con, $_POST['hapuspengukuran']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_pengukuran_imunisasi") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_pengukuran_imunisasi WHERE id = '$hpspengukuran'") or die(mysqli_error($con));
                ?>
