        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <!-- <a href="tambahpengguna.php" class="btn btn-default btn-md" style="background-color:#001f3f;"
               ...
               <button type="button" class="btn btn-md bg-gradient-primary"
                  data-toggle="modal" data-target="#modal-tambah">
                   <i class="nav-icon fas fa-plus">&nbsp</i>Tambah Data</button>
                    ...
                    if(mysqli_num_rows($sql_pengguna) > 0)
                    {
                        while($data = mysqli_fetch_array($sql_pengguna))
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                  <center>
                                 <button type="button" class="btn btn-xs bg-gradient-info"
                                ...
                                <button type="button" class="btn btn-xs bg-gradient-danger"
                                 data-toggle="modal" data-target="#modal-default"data-id="<?=$data['id'];?>">
