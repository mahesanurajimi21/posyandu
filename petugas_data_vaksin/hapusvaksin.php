    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $hpsvaksin =trim(mysqli_real_escape_string($con, $_POST['dt_vaksin']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_vaksin") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_vaksin WHERE id = '$hpsvaksin'") or die(mysqli_error($con));
                ?>
                  ...
                  setTimeout(function() {
                  window.location.href = "../admin_datavaksin";
