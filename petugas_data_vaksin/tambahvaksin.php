  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        {
                    $smpnvaksin        = trim(mysqli_real_escape_string($con, $_POST['vaksin']));
                    
            $cekdata = mysqli_query($con, "SELECT * FROM tbl_vaksin WHERE nama_vaksin='$smpnvaksin'")
            ...
            if (mysqli_num_rows($cekdata) > 0)
            {
              ...
              <script> 
              swal("Error", "Jenis Vaksin sudah ada, silahkan ganti yang lain", "error");
            ...
            {
                mysqli_query($con, "INSERT INTO tbl_vaksin VALUES ('','$smpnvaksin')")
            or die(mysqli_error($con));
            ?>
              <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
              <script> 
