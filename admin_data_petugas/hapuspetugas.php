    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $id =trim(mysqli_real_escape_string($con, $_POST['no_dusun']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_petugas") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_petugas WHERE id = '$id'") or die(mysqli_error($con));
                mysqli_query($con, "DELETE FROM tbl_penggunaa WHERE id_petugas = '$id'") or die(mysqli_error($con));
