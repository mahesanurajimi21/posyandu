        ...
        <div class="row">
          ...
          <div class="card">
            <div class="card-header" style="background-color:#4682B4">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form role="form" class="form-layout" action="cetak.php" method="post">													
                  <div class="row">
                    ...
                    <a href="#" class="btn btn btn-md"style="background-color:#4682B4" role="button" onclick="window.open('print.php', 
