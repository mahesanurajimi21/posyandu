          ...
          <div class="card">
              ...
              <!-- <form class="form-horizontal"> -->
                ...
                <div class="form-group">           
                  ...
                  <button type="submit" class="btn btn-md bg-gradient btn-block" style="background-color:#4682B4" name="updatepw">
                  <font color ="#fffff"><i class="nav-icon fas fa-sync">&nbsp</i>Update Password</font></button>
                  </form>
                  </div>
              </div>
              <!-- /.card-body -->
