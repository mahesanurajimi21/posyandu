  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Data Anak Peserta</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $nikanak =trim(mysqli_real_escape_string($con, $_POST['hapusanak']));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_anak WHERE nik = '$nikanak'") or die(mysqli_error($con));

                mysqli_query($con, "DELETE FROM tbl_pengukuran_imunisasi WHERE nik = '$nikanak'") or die(mysqli_error($con));
