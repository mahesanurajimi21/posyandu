        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <!-- <a href="tambahpengguna.php" class="btn btn-default btn-md" style="background-color:#001f3f;"
               ...
               <a class="btn btn-md bg-gradient-warning" href="../petugas_data_peserta"><i class="nav-icon fas fa-chevron-left">&nbsp</i> Kembali</a>
...
<div class="modal fade" id="modal-default">
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          <div class="modal-content">
          <div class="modal-header" style="background-color:#4682B4;">
              <h5 class="modal-title"><font color="#ffffff">Edit Data Peserta</font></h5>
            </div>
            <div class="modal-body">
