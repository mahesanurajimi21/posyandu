    ...
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            require_once "../database/config.php";
            $NKK =trim(mysqli_real_escape_string($con, $_POST['nik_anak']));

            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_peserta") or die(mysqli_error($con));
          ...
          ?>
                  ...
                  <script> 
                  swal("Gagal", "Data Tidak Bia Dihapus", "error");

                  setTimeout(function() {
                  window.location.href = "../petugas_data_peserta";
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_peserta WHERE kode = '$NKK'") or die(mysqli_error($con));

                mysqli_query($con, "DELETE FROM tbl_anak  WHERE kode_peserta = '$NKK'") or die(mysqli_error($con));

                mysqli_query($con, "DELETE FROM tbl_pengukuran_imunisasi  WHERE kd_peserta = '$NKK'") or die(mysqli_error($con));
