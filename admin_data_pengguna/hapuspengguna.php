      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            ...
            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_penggunaa") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_penggunaa WHERE NIP = '$nip'") or die(mysqli_error($con));

                mysqli_query($con, "DELETE FROM tbl_petugas WHERE no_hp = '$nip'") or die(mysqli_error($con));
