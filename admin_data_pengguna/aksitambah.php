  ...
  <div class="content-wrapper">
    ...
    <div class="content">
      <div class="container-fluid">
        ...
        {
          // $kkanak         = $_GET['id_peserta'];

                    $nip        = trim(mysqli_real_escape_string($con, $_POST['nip']));
                    $nama       = trim(mysqli_real_escape_string($con, $_POST['nama']));
                    $user       = trim(mysqli_real_escape_string($con, $_POST['user']));
                    $pass       = sha1(trim(mysqli_real_escape_string($con, $_POST['pass'])));
                    $peran      = trim(mysqli_real_escape_string($con, $_POST['peranptgs']));
                    $wiloperasi = trim(mysqli_real_escape_string($con, $_POST['wilayahoperasi']));


            $cekdata = mysqli_query($con, "SELECT * FROM tbl_penggunaa WHERE NIP='$nip'
             OR username='$user'")
            ...
            if (mysqli_num_rows($cekdata) > 0)
            {
              ...
              <script> 
              swal("Error", "NIP atau Username sudah digunakan, silahkan ganti yang lain", "error");
            ...
            {
                mysqli_query($con, "INSERT INTO tbl_penggunaa VALUES ('','$nip','$user','$pass','$nama','$peran','$wiloperasi')")
            or die(mysqli_error($con));
            ?>
              <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
              <script> 
