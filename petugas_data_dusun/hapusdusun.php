      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <?php
            ...
            $sql_cek_pengguna = mysqli_query($con, "SELECT * FROM tbl_dusun") or die(mysqli_error($con));
          ...
          ?>
                ...
                {
                mysqli_query($con, "DELETE FROM tbl_dusun WHERE id = '$id'") or die(mysqli_error($con));
                ?>
