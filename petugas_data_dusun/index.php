              ...
              <!-- <a href="tambahpengguna.php" class="btn btn-default btn-md" style="background-color:#001f3f;"
               ...
               <button type="button" class="btn btn-md bg-gradient-primary"
                  data-toggle="modal" data-target="#modal-tambah">
                   <i class="nav-icon fas fa-plus">&nbsp</i>Tambah Data Dusun</button>
                        ...
                        while($data = mysqli_fetch_array($sql_pengguna))
                        {
                            ...
                            <tr>
                                ...
                                <button type="button" class="btn btn-xs bg-gradient-danger"
                                 data-toggle="modal" data-target="#modal-default"data-nip="<?=$data['id'];?>">
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog">
          ...
          <div class="modal-header" style="background-color:#8B0000;">
            ...
            <div class="form-group">           
                <label for="exampleInputEmail1">Kontak Kadus</label>
                <input type="text" class="form-control" name="ktkds"placeholder="Nomer Kontak Kadus"required>
            </div>

            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default btn-md"  data-dismiss="modal">
                <i class="nav-icon fas fa-times"></i>Tutup</button>
              <button type="submit" name ="edit"class="btn btn-info btn-md"><i class="nav-icon fas fa-edit"></i>Edit Data</font></button>
              </form>
            </div>
